...
export const CAPABILITY_EVIDENCE_GENERATED_AT = "2026-03-17T13:20:00.000Z";
...
export const MODULE_MATURITY_SOURCE: ModuleMaturityInfo[] = [
  ...
  },
  {
    ...
    "sourceUpdatedAt": "2026-03-14",
    "validationLevel": "unit",
    "notes": "Beta is held on remaining deferred risks: OAuth token acquisition and multi-server routing.",
    "trackedDecision": {
      "packageId": "phase3/node-integrations/mcphost-held-risk-reduction",
      "module": "NodeMCPHost",
      "oldMaturity": "beta",
  ...
  },
  {
    ...
    "validatedAt": "2026-03-15",
    "validationLevel": "unit",
    "notes": "Core subset (create/followUp/createTextResult/followUpTextResult) is promoted via tracked decision; stream, JSON/messages, reasoning, and chat-completion helpers remain deferred/provider-only.",
    "trackedDecision": {
      "packageId": "phase3/cloud-surface/responseapi-beta-promotion",
      "module": "ResponseAPI",
      "oldMaturity": "experimental",
