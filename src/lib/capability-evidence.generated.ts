...
export const CAPABILITY_EVIDENCE_GENERATED_AT = "2026-03-18T00:00:00.000Z";
...
export const MODULE_MATURITY_SOURCE: ModuleMaturityInfo[] = [
  ...
  },
  {
    ...
    "sourceUpdatedAt": "2026-03-14",
    "validationLevel": "unit",
    "notes": "Beta is held on remaining deferred risks: OAuth token acquisition beyond already-resolved bearer tokens and cross-server routing.",
    "trackedDecision": {
      "packageId": "phase3/node-integrations/mcphost-oauth-boundary",
      "module": "NodeMCPHost",
      "oldMaturity": "beta",
